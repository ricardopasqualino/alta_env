...
class AddPrice(models.Model):
    ...
    cnpj = models.CharField(default=None, null=True, blank=True, max_length=100, verbose_name='CNPJ', db_index=True)
    gasstation_id = models.ForeignKey(GasStation, on_delete=models.DO_NOTHING, default=None, null=True, blank=True, verbose_name='Lista de Postos', db_index=True)
...
class Profile(models.Model):
    ...
    cidade = models.ForeignKey(Cidade, on_delete=models.CASCADE, default=None, null=True, blank=True, verbose_name='Cidade')
    estado = models.ForeignKey(Estado, on_delete=models.CASCADE, default=None, null=True, blank=True, verbose_name='Estado')
